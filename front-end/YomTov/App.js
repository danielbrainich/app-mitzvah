...
export default function App() {
    ...
    useEffect(() => {
        const fetchHolidays = async () => {
            ...
            try {
                const response = await fetch(`http://localhost:8000/api/holidays/${date}`);
                if (!response.ok) {
                ...
                >
                    <View style={styles.frame}>
                        {holidays?.holiday_info?.previous ? (
                            <View>
                                <Text style={styles.headerText}>Just passed</Text>
                            ...
                            <View>
                                <Text style={styles.headerText}>Error loading</Text>
                                <Text style={styles.bigBoldText}>
                    ...
                    <View style={styles.frame}>
                        {holidays?.holiday_info?.today ? (
                            <View>
                                ...
                                <Text style={styles.dateText}>
                                    {formatDate(holidays.holiday_info.today.date)}
                                </Text>
                                <Text style={styles.paragraphText}>
                    ...
                    <View style={styles.frame}>
                        {holidays?.holiday_info?.next ? (
                            <View>
                                <Text style={styles.headerText}>Next up</Text>
                                <Text style={styles.bigBoldText}>
                                ...
                                <Text style={styles.dateText}>
                                    {formatDate(holidays.holiday_info.next.date)}
                                </Text>
                                <Text style={styles.paragraphText}>
